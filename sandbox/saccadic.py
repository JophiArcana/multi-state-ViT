...
if __name__ == "__main__":
    ...
    #
    # images = []
    # class_idx, subsample_size = {0, 1, 2}, 4    # 50
    ...
    from model.saccadic_encoder.configuration_scvit import SaccadicViTConfig
    from model.saccadic_encoder.modeling_scvitencoder import SaccadicViTPatchEmbeddings
    ...
    inputs = torch.randn((5, 3, 448, 448))

    PE = SaccadicViTPatchEmbeddings(SaccadicViTConfig(image_size=image_size))
    PE.forward(inputs, torch.tensor((0.0, 0.0, 1.0, 0.0)).expand((5, 4)))
    raise Exception()
